...
# Team Builder strip removed — page hidden from users' view (lives at
# Team_Builder_disabled.py; its model is also inside Contract Predictor's team
# mode). Restore by un-disabling pages/Team_Builder.py + re-adding the nav entry
# in utils.py, then uncommenting this strip.
# render_strip(
#     name="Team Builder",
#     href="/Team_Builder",
#     accent="#9b59b6",
